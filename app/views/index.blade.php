...
<div class="container">
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navbar-header">
           <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="#">Stephanie Riera</a>
...
<div class="col-md-6 col-md-offset-6">
      ...
      <h1 id='top' class="text-primary text-center" style="padding-top: 55px">
         Stephanie Riera 
      </h1>

      <div class="row">
        <div class="col-md-2 col-md-offset-5">
          <img alt="140x140" src="/images/pensive.jpg" class="img-circle img-responsive" style="padding-top: 10px" />
        </div>

    <div class="col-md-6 col-md-offset-3">
    <h3 class="text-center text-muted">
        Jr. Web Developer / San Antonio, TX 
    </h3>
  </div> 
  </div>
...
<h2>My Current Skillset</h2>
        <h5>(because one must always continue learning..)</h5>
      <dl>
        <dt>
          HTML5
        </dt>
...
<a href="#top"><i class="fa fa-home fa-2x"></i>Go to the top of the page</a>
